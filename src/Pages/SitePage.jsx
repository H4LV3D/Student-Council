          ...
          <div className="flex flex-col items-center justify-center">
            <section className="container w-full absolute z-40">
              <div className="px-6 sm:px-8 md:px-0 z-30">
                <h2 className="text-6xl sm:text-7xl md:text-7xl lg:text-7xl text-start font-raleway font-black text-white lg:w-1/2">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center ">
            <section className="container flex items-center lg:pt-0">
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-gray-700 font-normal font-raleway text-center text-xl md:text-2xl lg:text-3xl xl:text-3xl leading-7 md:leading-10 xl:w-1/2 mt-4 px-6 sm:px-0">
                  {siteDetails.sectionText}
                </p>

                {siteDetails?.bullet.map((bullet, index) => {
                  return (
                    <p className="text-gray-700 font-normal font-raleway text-center text-lg md:text-xl lg:text-xl xl:text-xl leading-7 md:leading-10 xl:w-1/2 mt-4 px-6 sm:px-0">
                      {bullet}{" "}
                    </p>
                  );
                })}
